...
const server = app.listen(PORT, () => console.log(`CRM Tasatop Web v1.441 (Ajustes Comité B2B: (1) FIX filtro por funcionario: el selector ahora envía el nombre completo que matchea responsableActual. (2) Botón Llamadas movido a la derecha junto a Análisis IA. (3) Alertas contraídas por default con botón Expandir/Contraer. (4) Meta: la global es del equipo (responsable Dante, Jefe B2B) y solo se listan funcionarios CON meta individual asignada (Bony, Shirley). (5) Eliminados: embudo por funcionario, avances de etapa por día, avances por transición, índice de gestión por ejecutivo. (6) Embudo comercial vertical compacto en recuadro con vivos/desestimados/monto por etapa; clic en vivos o desestimados abre lista detallada (empresa, responsable, monto, días en etapa, días sin gestión / motivo y tiempo vivo). (7) Llamadas por día = gestiones canal llamada, SOLO días con registros, con empresas únicas y etiquetas de datos, sin acumulado. (8) A qué hora se gestiona: líneas por funcionario, eje X horas con actividad, etiquetas de datos, eje Y gestiones. (9) Leads recibidos por día: pie con cantidad, % y monto. (10) Desestimados: motivos agrupados por CATEGORÍA (antes del guion) para que cuadre con el total; última etapa con etiquetas de n + monto. (11) Top riesgo angosto sin # con días en etapa y días sin gestión. (12) La vista usa todo el ancho de la página y los gráficos son compactos para caber en una pantalla al 100%. Plugin chartjs-plugin-datalabels agregado. Front: Ctrl+F5) corriendo en puerto ${PORT}`));
